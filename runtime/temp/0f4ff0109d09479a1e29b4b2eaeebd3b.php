<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"D:\web\zijiBlog\public/../application/index\view\blog\index.html";i:1551160946;s:55:"D:\web\zijiBlog\application\index\view\public\base.html";i:1546248022;s:57:"D:\web\zijiBlog\application\index\view\public\header.html";i:1551268041;s:54:"D:\web\zijiBlog\application\index\view\blog\right.html";i:1534833419;s:57:"D:\web\zijiBlog\application\index\view\public\footer.html";i:1546247272;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="col-md-8">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item  <?php if($key == 0): ?> active  <?php endif; ?>">
                <a href="<?php echo url('index/blog/view',['id'=>$vo['id']]); ?>">
                    <img src="/public/static/upload/<?php echo $vo['image']; ?>" alt="<?php echo $vo['title']; ?>" style="width:100%;height:300px;">
                </a>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <p><?php echo mb_substr($vo['content'],0,30); ?></p>
        </div>
        <div class="panel-footer">
            作者:<a href="<?php echo url('index/user/center',['id'=>$vo['uid']]); ?>"><?php echo $vo->author->phone; ?></a>
            创建时间:<span><?php echo $vo['created']; ?></span>
            浏览量(<?php echo $vo['view']; ?>)
        </div>
    </div>
    <?php endforeach; endif; else: echo "" ;endif; ?>
